...
<body class="projects-page">
  ...
  <main class="main">
    ...
    <!-- Projects Section -->
    <section id="blog-posts" class="blog-posts section get-started section">
      <!-- Section Title -->
      <div class="container section-title" data-aos="fade-up">
        <h2>TYPICAL DONCASSA PROJECTS</h2>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            <article class="position-relative h-100">
              <div class="post-img position-relative overflow-hidden">
                <img src="assets/img/projects/cng-download.png" class="img-fluid height-350" alt="">
              </div>
              <div class="post-content d-flex flex-column">
          ...
          <div class="col-lg-4">
            <article class="position-relative h-100">
              <div class="post-img position-relative overflow-hidden">
                <img src="assets/img/projects/right.png" class="img-fluid height-350 w-100" alt="">
              </div>
              <div class="post-content d-flex flex-column">
                <h3 class="post-title">Right CNG depenser</h3>
                <p class="justify-text-in">
                  Right; Typical single unit CNG dispenser.
                </p>
                <hr>
              </div>
            </article>
